...
function e(name: string, spriteKey: string, hp: number, damage: number, displaySize = 100): EnemyTemplate {
...
const Agna: EnemyTemplate = {
  name: "Agna", spriteKey: "boss-agna-1", hp: 90, damage: 16,
  displaySize: 370, displayW: 332, isStatic: true, phase2Key: "boss-agna-2",
};
const FinalBoss: EnemyTemplate = {
  name: "The Dark One", spriteKey: "boss-finalboss-1", hp: 100, damage: 18,
  displaySize: 370, displayW: 368, isStatic: true, phase2Key: "boss-finalboss-2",
};
...
export function pickCombatEncounter(): Encounter {
  return COMBAT_ENCOUNTERS[Math.floor(Math.random() * COMBAT_ENCOUNTERS.length)];
}
